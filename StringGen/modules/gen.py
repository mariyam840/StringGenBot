...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@ArmanChatz"))
        else:
            ...
            await client.join_chat("ArmanChatz")
    except KeyError:
        pass
    try:
